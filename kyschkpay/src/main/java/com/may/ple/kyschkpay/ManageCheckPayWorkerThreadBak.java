...
public class ManageCheckPayWorkerThreadBak extends Thread {
	private static final Logger LOG = Logger.getLogger(ManageCheckPayWorkerThreadBak.class.getName());
	private List<String> prodIds;
	private static final String USERNAME = "system";
	private static final String PASSWORD = "w,j[vd8iy[";
	
	public ManageCheckPayWorkerThreadBak(List<String> prodIds) {
